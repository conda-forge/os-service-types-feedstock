About os-service-types-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/os-service-types-feedstock/blob/main/LICENSE.txt)
...
Development: https://git.openstack.org/cgit/openstack/os-service-types
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3162&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/os-service-types-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `os-service-types` can be installed with `conda`:
...
```
mamba install os-service-types
```

It is possible to list all of the versions of `os-service-types` available on your platform with `conda`:
...
```
mamba search os-service-types --channel conda-forge
```
...
mamba repoquery search os-service-types --channel conda-forge

# List packages depending on `os-service-types`:
mamba repoquery whoneeds os-service-types --channel conda-forge

# List dependencies of `os-service-types`:
mamba repoquery depends os-service-types --channel conda-forge
```
